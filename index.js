...
const token = "6162413501:AAFpLNIdZVzt1UZ1zFq-uVki0wDzyyk-Qt8";
...
bot.on("message", async (msg) => {
    ...
    try {
        const response = await axios.get(
          `https://api.openweathermap.org/data/2.5/weather?q=${userInput}&appid=bda665138fca7ecff7610650f74f4988`
        );
